	...
	public void onBypassCommand(Player player, String bypass)
	{
		...
		if("bbsgetfav".equals(cmd))
		{
			...
			try
			{
				...
				String tpl = HtmCache.getInstance().getNotNull(Config.BBS_HOME_DIR + "bbs_favoritetpl.htm", player);
				while(rset.next())
				{
			...
			String html = HtmCache.getInstance().getNotNull(Config.BBS_HOME_DIR + "bbs_getfavorite.htm", player);

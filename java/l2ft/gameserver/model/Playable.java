...
import l2ft.gameserver.templates.CubicTemplate;
...
public abstract class Playable extends Creature
{
	...
	public void doAttack(Creature target)
	{
		...
		{
			player.sendMessage(new CustomMessage("l2ft.gameserver.model.L2Playable.OutOfControl.ObserverNoAttack", player));
			return;
		}

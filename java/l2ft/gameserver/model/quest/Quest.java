package l2ft.gameserver.model.quest;
...
import l2ft.commons.logging.LogUtils;
import l2ft.commons.threading.RunnableImpl;
import l2ft.commons.util.TroveUtils;
...
import l2ft.gameserver.network.l2.s2c.ExNpcQuestHtmlMessage;
...
public class Quest
{
	...
	/**
	 * Добавляет нпц масив для слушателя при их убийстве, и обновлении пакетом {@link l2ft.gameserver.network.l2.s2c.ExQuestNpcLogList}
	 * @param cond
	 * @param varName
	 * @param killIds
	 */

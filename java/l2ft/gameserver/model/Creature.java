...
import l2ft.gameserver.geodata.GeoMove;
import l2ft.gameserver.instancemanager.DimensionalRiftManager;
import l2ft.gameserver.instancemanager.ReflectionManager;
import l2ft.gameserver.model.GameObjectTasks.AltMagicUseTask;
import l2ft.gameserver.model.GameObjectTasks.CastEndTimeTask;
import l2ft.gameserver.model.GameObjectTasks.HitTask;
import l2ft.gameserver.model.GameObjectTasks.MagicLaunchedTask;
import l2ft.gameserver.model.GameObjectTasks.MagicUseTask;
...
import l2ft.gameserver.model.actor.recorder.CharStatsChangeRecorder;
...
import l2ft.gameserver.stats.StatFunctions;
...
import l2ft.gameserver.taskmanager.RegenTaskManager;
...
public abstract class Creature extends GameObject
{
	...
	public class MoveNextTask extends RunnableImpl
	{
		...
		public void runImpl() throws Exception
		{
			...
			try
			{
				...
				Location loc = moveList.get(index).clone().geo2world();
	...
	public double absorbToSummon(Creature attacker, double damage)
	{
		...
		if(transferToSummonDam > 0)
		{
			...
			//if(summon.getEffectList().getEffectsBySkillId(4515) != null && Config.CANCELED_SKILL_RAID_CURSE_FOR_TP)
			//	summon.getEffectList().stopEffect(4515);
			if(summon == null || summon.isDead() || summon.getCurrentHp() < transferDamage || summon.getEffectList().getEffectsBySkillId(4515) != null)

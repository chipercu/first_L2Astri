...
import l2ft.gameserver.model.entity.events.objects.SiegeToggleNpcObject;
import l2ft.gameserver.model.entity.events.objects.SpawnExObject;
import l2ft.gameserver.model.entity.events.objects.SpawnSimpleObject;
import l2ft.gameserver.model.entity.residence.Castle;
import l2ft.gameserver.model.instances.ArtefactInstance;
...
public class CastleSiegeEvent extends SiegeEvent<Castle, SiegeClanObject>
{
	...
	/**
	 * Ставит осадное время вручну, вызывается с пакета {@link l2ft.gameserver.network.l2.c2s.RequestSetCastleSiegeTime}
	 * @param id
	 */

package l2ft.gameserver.templates.npc;
...
public final class NpcTemplate extends CharTemplate
{
	...
	private void setType(String type)
	{
		...
		try
		{
			classType = (Class<NpcInstance>) Class.forName("l2ft.gameserver.model.instances." + type + "Instance");
		}
	...
	private void setAI(String ai)
	{
		...
		try
		{
			classAI = (Class<CharacterAI>) Class.forName("l2ft.gameserver.ai." + ai);
		}
		catch(ClassNotFoundException e)
		{

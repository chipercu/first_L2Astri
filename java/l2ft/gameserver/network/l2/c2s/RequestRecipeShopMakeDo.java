...
import l2ft.gameserver.model.RecipeComponent;
...
import l2ft.gameserver.network.l2.s2c.RecipeShopItemInfo;
...
public class RequestRecipeShopMakeDo extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			manufacturer.sendMessage(new CustomMessage("l2ft.gameserver.RecipeController.NoRecipe", manufacturer).addString(recipeList.getRecipeName()));
			buyer.sendMessage(new CustomMessage("l2ft.gameserver.RecipeController.NoRecipe", manufacturer).addString(recipeList.getRecipeName()));
			return;
		}
		...
		manufacturer.sendMessage(new CustomMessage("l2ft.gameserver.RecipeController.GotOrder", manufacturer).addString(recipeList.getRecipeName()));

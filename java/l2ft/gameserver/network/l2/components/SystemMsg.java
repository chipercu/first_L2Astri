...
public enum SystemMsg implements IStaticPacket
{
	...
	// Message: $s1 minute(s) of usage time lel2ft.
	...
	// Message: Use of your account has been limited due to alleged account thel2ft. If you have nothing to do with account theft, please visit the Support Center on the NCsoft website (http://us.ncsol2ft.com/support).
	USE_OF_YOUR_ACCOUNT_HAS_BEEN_LIMITED_DUE_TO_ALLEGED_ACCOUNT_THEFT(428),
	// Message: In accordance with company policy, your account has been suspended for submitting a false report. Submitting a false report to the Support Center may harm other players. For more information on account suspension, please visit the Support Center on the NCsoft website (http://us.ncsol2ft.com/support).
	...
	// Message: Your account has been suspended for violating the EULA, RoC and/or User Agreement. When a user violates the terms of the User Agreement, the company can impose a restriction on the applicable user's account. For more information on account suspension, please visit the Support Center on the NCsoft website (http://us.ncsol2ft.com/support).
	YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_VIOLATING_THE_EULA_ROC_ANDOR_USER_AGREEMENT(431),
	// Message: Your account has been suspended for 7 days (retroactive to the day of disclosure), under Chapter 3, Section 14 of the Lineage II Service Use Agreement, for dealing or attempting to deal items or characters (accounts) within the game in exchange for cash or items of other games. Suspension of your account will automatically expire after 7 days. For more information, please visit the Support Center on the NCsoft website (http://us.ncsol2ft.com/support).
	...
	// Message: Your account has been suspended, under Chapter 3, Section 14 of the Lineage II Service Use Agreement, for dealing or attempting to deal items or characters (accounts) within the game in exchange for cash or items of other games. For more information, please visit the Support Center on the NCsoft website (http://us.ncsol2ft.com/support).
	...
	// Message: Your account has been suspended, under Chapter 3, Section 14 of the Lineage II Service Use Agreement, for unethical behavior or fraud. For more information, please visit the Support Center on the NCsoft website (http://us.ncsol2ft.com/support).
	...
	// Message: Your account has been suspended for unethical behavior. For more information, please visit the Support Center on the NCsoft website (http://us.ncsol2ft.com/support).
	YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_UNETHICAL_BEHAVIOR(435),
	// Message: Your account has been suspended for abusing the game system or exploiting bug(s). Abusing bug(s) may cause critical situations as well as harm the game world's balance. For more information, please visit the Support Center on the NCsoft website (http://us.ncsol2ft.com/support).
	YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_ABUSING_THE_GAME_SYSTEM_OR_EXPLOITING_BUGS(436),
	// Message: Your account has been suspended for using illegal software which has not been authorized by our company. For more information, please visit the Support Center on the NCsoft website (http://us.ncsol2ft.com/support).
	YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_USING_ILLEGAL_SOFTWARE_WHICH_HAS_NOT_BEEN_AUTHORIZED_BY_OUR_COMPANY(437),
	// Message: Your account has been suspended for impersonating an official Game Master or staff member. For more information, please visit the Support Center on the NCsoft website (http://us.ncsol2ft.com/support).
	YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_IMPERSONATING_AN_OFFICIAL_GAME_MASTER_OR_STAFF_MEMBER(438),
	// Message: In accordance with the company's User Agreement and Operational Policy this account has been suspended at the account holder's request. If you have any questions regarding your account please contact support at http://us.ncsol2ft.com/support.
	...
	// Message: Because you are registered as a minor, your account has been suspended at the request of your parents or guardian. For more information, please visit the Support Center on the NCsoft website (http://us.ncsol2ft.com/support).
	BECAUSE_YOU_ARE_REGISTERED_AS_A_MINOR_YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_AT_THE_REQUEST_OF_YOUR_PARENTS_OR_GUARDIAN(440),
	// Message: Per our company's User Agreement, the use of this account has been suspended. If you have any questions regarding your account please contact support at http://us.ncsol2ft.com/support.
	PER_OUR_COMPANYS_USER_AGREEMENT_THE_USE_OF_THIS_ACCOUNT_HAS_BEEN_SUSPENDED(441),
	// Message: Your account has been suspended, under Chapter 2, Section 7 of the Lineage II Service Use Agreement, for misappropriating payment under another player's account. For more information, please visit the Support Center on the NCsoft website (http://us.ncsol2ft.com/support).
	...
	// Message: Ownership of this account needs to be verified. For more information, Please submit a ticket at the Support Center on the NCsoft website (http://us.ncsol2ft.com/support).
	...
	// Message: For more information, please visit the Support Center on the NCsoft website (http://us.ncsol2ft.com/support).
	...
	// Message: For more details, please contact our customer service center at http://us.ncsol2ft.com/support.
	...
	// Message: Starving, grumpy and fed up, your pet has lel2ft.
	...
	// Message: If you need help, please visit the Support Center on the PlayNC website (http://us.ncsol2ft.com/support/).
	...
	// Message: You have recommended $c1. You have $s2 recommendations lel2ft.
	...
	// Message: To create a new account, please visit the PlayNC website (http://us.ncsol2ft.com/support/).
	TO_CREATE_A_NEW_ACCOUNT_PLEASE_VISIT_THE_PLAYNC_WEBSITE_HTTPUS(1186),
	// Message: If you've forgotten your account information or password, please visit the Support Center on the PlayNC website (http://us.ncsol2ft.com/support/).
	...
	// Message: $s1, to better server our customers, all chat histories are stored and maintained by NCsol2ft.  If you do not agree to have your chat records stored, please close the chat window now.  For more information regarding this procedure, please visit our home page at www.PlayNC.com.  Thank you!
	...
	// Message: Your account has been suspended for 7 days because an illicit cash/account transaction has been detected. For more information, please visit the Support Center on the PlayNC website (http://us.ncsol2ft.com/support/).
	YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_7_DAYS_BECAUSE_AN_ILLICIT_CASHACCOUNT_TRANSACTION_HAS_BEEN_DETECTED(1804),
	// Message: Your account has been suspended for 30 days because an illicit cash/account transaction has been detected for the second time. For more information, please visit the Support Center on the PlayNC website (http://us.ncsol2ft.com/support/).
	...
	// Message: Your account has been permanently suspended because an illicit cash/account transaction has been detected for the third time. For more information, please visit the Support Center on the PlayNC website (http://us.ncsol2ft.com/support/).
	...
	// Message: Your account has been suspended for 30 days because of your involvement in an illicit cash transaction. For more information, please visit the Support Center on the PlayNC website (http://us.ncsol2ft.com/support/).
	YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_30_DAYS_BECAUSE_OF_YOUR_INVOLVEMENT_IN_AN_ILLICIT_CASH_TRANSACTION(1807),
	// Message: Your account has been permanently suspended because of your involvement in an illicit cash/account transaction. For more information, please visit the Support Center on the PlayNC website (http://us.ncsol2ft.com/support/).
	YOUR_ACCOUNT_HAS_BEEN_PERMANENTLY_SUSPENDED_BECAUSE_OF_YOUR_INVOLVEMENT_IN_AN_ILLICIT_CASHACCOUNT_TRANSACTION(1808),
	// Message: Your account must be verified. For information on verification procedures, please visit the PlayNC website (http://us.ncsol2ft.com/support/).
	...
	// Message: You must accept the User Agreement before this account can access Lineage II.\n Please try again after accepting the agreement on the PlayNC website (http://us.ncsol2ft.com).
	...
	// Message: Your account may have been involved in identity thel2ft. As such, it has been temporarily restricted. If this does not apply to you, you may obtain normal service by going through self-identification on the homepage. Please refer to the plaync homepage (www.plaync.co.kr) customer center (Lineage 2) clause 1:1 for more details.
	...
	// Message: Your account has been temporarily suspended for playing the game in abnormal ways. If you did not use abnormal means, please visit the Support Center on the NCsoft website (http://us.ncsol2ft.com/support).

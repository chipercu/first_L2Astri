...
import l2ft.commons.compiler.Compiler;
import l2ft.commons.compiler.MemoryClassLoader;
import l2ft.gameserver.Config;
import l2ft.gameserver.model.Player;
import l2ft.gameserver.model.quest.Quest;
import l2ft.gameserver.scripts.jarloader.JarClassLoader;
...
public class Scripts
{
	...
	private void load()
	{
		...
		File f = new File("../serverslibs/l2ft-scripts.jar");
		if(f.exists())
		{
			JarClassLoader jcl;
			try
			{
				jcl = new JarClassLoader("../serverslibs/l2ft-scripts.jar");
			...
			{
				_log.error("Fail to load l2ft-scripts.jar!", e);
				classes.clear();
			}
			finally
			{
